...
public class ServicioEquipoTest {
    ...
    private static final Usuario USUARIO2 = new Usuario("mail@mail.com", "123");
    private static final Usuario USUARIO3 = new Usuario("scortes@mail.com", "123");
    private static final Usuario USUARIO4 = new Usuario("scortes@mail.com", "123");
    private static final Usuario USUARIO5 = new Usuario("scortes@mail.com", "123");
    private static final Usuario USUARIO6 = new Usuario("scortes@mail.com", "123");
    ...
    private static Equipo EQUIPO = new Equipo("El Mejor", 3, 5, "Juvenil");
    private static Equipo EQUIPO_LLENO = new Equipo("El Mejor", 5, 5, "Juvenil");
    ...
    private void thenNoSeAgregaUnJugadorMasAlEquipo(Equipo equipo) {
        verify(repositorioEquipo, never()).actualizarEquipo(any());
    }
