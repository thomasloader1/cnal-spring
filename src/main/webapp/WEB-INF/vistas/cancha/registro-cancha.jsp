        ...
        <div id="registrarCancha" class="col-md-12">
            <form:form action="registrar-cancha" method="POST" modelAttribute="cancha-nueva">
                ...
                <div class="form-outline mb-4">
                    ...
                    <select name="cant_canchas" id="defaultRegisterFormCantCanchas" class="form-control">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input name="precio" id="defaultRegisterFormPrecio" class="form-control"/>
                </div>

                <div class="form-outline mb-4">
                    <label class="form-label">Posee servicio de bar</label>
                    <select name="bar" id="defaultRegisterFormBar" class="form-control">
